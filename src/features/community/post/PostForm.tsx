...
export default function PostForm() {
  const [cat, setCat] = useState<"free" | "qna" | "info">("free");
  ...
  return (
    <form onSubmit={submit} className="m-auto w-main py-8 text-gray-900">
      {/* category */}
      <CategoryRadioGroup value={cat} onChange={setCat} />
      {/* title */}
      <div className="my-4">
